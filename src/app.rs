...
impl App {
    ...
    // --- NOVO MÉTODO DE SALVAR (Fase 7) ---
    pub fn save_file(&self) {
        if let Some(filename) = &self.filename {
            let content = self.buffer.join("\n");
            // Tentamos escrever no disco.
            // Para o MVP, ignoramos erros (como permissão negada),
            // mas num produto final trataríamos isso com um Popup de Erro.
